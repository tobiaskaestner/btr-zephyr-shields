...
def emit(solved: Solved, workdir: str) -> dict[str, str]:
    outputs = {
        ...
        "config-sheet.md": _sheet(solved, workdir),
...
def _sheet(s: Solved, workdir: str) -> str:
    ...
    out += _params_table(s, workdir)
    return "\n".join(out) + "\n"


def _params_table(s: Solved, workdir: str) -> list[str]:
