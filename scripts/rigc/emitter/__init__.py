...
# These five MUST follow GEN's assignment above: overlay.py/sheet.py/
# expectations.py read it from this package at import time, which is the whole
# reason the banner is defined here and not once per file. Hoisting them to the
# top is a NameError, so E402 is suppressed per-line -- the same way
# scripts/west_commands/rigs.py marks its own path-dependent imports.
from ..analyzer import Solved  # noqa: E402
from ..model import ConnectorType, Rig  # noqa: E402
from .expectations import render_expectations  # noqa: E402
from .overlay import render_overlay  # noqa: E402
from .sheet import render_sheet  # noqa: E402
